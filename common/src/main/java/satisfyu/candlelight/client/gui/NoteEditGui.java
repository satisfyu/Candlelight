...
public class NoteEditGui extends Screen {
    ...
    protected void init() {
        ...
        this.previousPageButton = this.addRenderableWidget(new PageButton(i + 43, 159, false, (button) -> {
    ...
    public void render(PoseStack matrices, int mouseX, int mouseY, float delta) {
        ...
        if (this.signing) {
            ...
            int n = this.font.width(this.pageIndicatorText);
            this.font.draw(matrices, this.pageIndicatorText, (float)(i - n + 192 - 44), 18.0F, 0);
            PageContent pageContent = this.getPageContent();
    ...
    private PageContent getPageContent() {
        if (this.pageContent == null) {
            ...
            this.pageIndicatorText = Component.translatable("book.pageIndicator", this.currentPage + 1, this.countPages());
        }
