...
import satisfyu.candlelight.block.crops.WildLettuce;
...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Item> LETTUCE_SEEDS = registerItem("lettuce_seeds", () -> new BlockItem(LETTUCE_CROP.get(), getSettings()));
    ...
    public static final RegistrySupplier<Block> WILD_LETTUCE = registerWithoutItem("wild_lettuce", () -> new WildLettuce(getBushSettings()));
