...
import satisfyu.candlelight.block.entity.chair.ChairEntity;
import satisfyu.candlelight.util.CandlelightIdentifier;

import java.util.function.Supplier;

public class EntityRegister {
    private static final Registrar<EntityType<?>> ENTITY_TYPES = DeferredRegister.create(Candlelight.MOD_ID, Registry.ENTITY_TYPE_REGISTRY).getRegistrar();
