...
public class DressHelmetItem extends DyeableArmorItem implements ICustomArmor {
    public DressHelmetItem(ArmorMaterial material, Properties settings) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level world, @NotNull List<Component> tooltip, TooltipFlag context) {
        if (null != world && world.isClientSide()) {
            ArmorRegistry.appendDressTooltip(tooltip);
        }
    }
}