...
public class CandlelightStandardItem extends StandardItem {
    public CandlelightStandardItem(Properties properties) {
        super(properties, CandlelightIdentifier.of("textures/standard/candlelight_standard.png"), () -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 200, 1, true, false, true));
    }
