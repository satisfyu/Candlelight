...
public class EntityTypeRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<CompletionistBannerEntity>> CANDLELIGHT_BANNER = registerBlockEntity("candlelight_standard", () -> BlockEntityType.Builder.of(CompletionistBannerEntity::new, ObjectRegistry.CANDLELIGHT_BANNER.get(), ObjectRegistry.CANDLELIGHT_WALL_BANNER.get()).build(null));
