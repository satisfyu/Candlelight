package net.satisfy.candlelight.compat.jei;
...
import net.satisfy.candlelight.compat.jei.transfer.CookingPanTransferInfo;
import net.satisfy.candlelight.compat.jei.transfer.CookingPotTransferInfo;
