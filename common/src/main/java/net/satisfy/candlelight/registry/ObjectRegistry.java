...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Item> BEETROOT_SALAD = registerItem("beetroot_salad", () -> new EffectItem(getFoodItemSettings(5, 0.6f, MobEffectRegistry.SUSTENANCE, 2400), 2400));
    ...
    public static final RegistrySupplier<Item> CHICKEN_TERIYAKI = registerItem("chicken_teriyaki", () -> new EffectItem(getFoodItemSettings(8, 0.8f, MobEffectRegistry.SATIATION, 6000), 6000));
    public static final RegistrySupplier<Item> SALAD = registerItem("salad", () -> new EffectItem(getFoodItemSettings(5, 0.7f, MobEffectRegistry.SUSTENANCE, 3600), 3600));
    public static final RegistrySupplier<Item> BEEF_TARTARE = registerItem("beef_tartare", () -> new EffectItem(getFoodItemSettings(8, 0.9f, MobEffectRegistry.SATIATION, 3000), 3000));
    ...
    public static final RegistrySupplier<Item> PASTA_WITH_LETTUCE = registerItem("pasta_with_lettuce", () -> new EffectItem(getFoodItemSettings(8, 0.9f, MobEffectRegistry.SATIATION, 3600), 3600));
    ...
    public static final RegistrySupplier<Item> OMELET = registerItem("omelet", () -> new EffectItem(getFoodItemSettings(8, 0.4f, MobEffectRegistry.SWEETS, 4800), 4800));
    ...
    public static final RegistrySupplier<Item> HARVEST_PLATE = registerItem("harvest_plate", () -> new EffectItem(getFoodItemSettings(7, 0.8f, MobEffectRegistry.FARMERS_BLESSING, 4800), 4800));
    ...
    public static final RegistrySupplier<Item> CHOCOLATE_MOUSSE = registerItem("chocolate_mousse", () -> new EffectItem(getFoodItemSettings(4, 0.3f, MobEffectRegistry.SWEETS, 2400), 2400));
