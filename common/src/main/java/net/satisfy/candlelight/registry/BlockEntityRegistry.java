...
import net.satisfy.candlelight.entity.*;
...
public class BlockEntityRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<SideBoardBlockEntity>> SIDEBOARD = create("sideboard", () -> BlockEntityType.Builder.of(SideBoardBlockEntity::new, ObjectRegistry.SIDEBOARD.get()).build(null));    public static final RegistrySupplier<BlockEntityType<LargeCookingPotBlockEntity>> COOKING_POT_BLOCK_ENTITY = create("cooking_pot", () -> BlockEntityType.Builder.of(LargeCookingPotBlockEntity::new, ObjectRegistry.COOKING_POT.get()).build(null));
