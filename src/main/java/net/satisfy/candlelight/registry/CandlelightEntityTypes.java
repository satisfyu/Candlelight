...
import net.satisfy.candlelight.block.entity.*;
...
public class CandlelightEntityTypes {
    ...
    public static final BlockEntityType<TypeWriterEntity> TYPE_WRITER_BLOCK_ENTITY = create("type_writer", FabricBlockEntityTypeBuilder.create(TypeWriterEntity::new, ObjectRegistry.TYPEWRITER_IRON, ObjectRegistry.TYPEWRITER_COPPER).build());
