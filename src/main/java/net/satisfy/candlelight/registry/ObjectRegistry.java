...
public class ObjectRegistry {
    ...
    public static final Block TOMATO_CROP = register("tomato_crop", new TomatoCropBlock(FabricBlockSettings.copy(Blocks.WHEAT)), false);
    ...
    public static final Block WILD_BROCCOLI = register("wild_broccoli", new WildBroccoli(FabricBlockSettings.of(Material.WOOD).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD)));
