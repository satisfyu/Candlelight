...
public class ObjectRegistry {
    ...
    public static final  Item     NOTE_PAPER_WRITTEN = registerBlockWithoutItem("note_paper_written", new Item(getSettings()));
    ...
    private static <T extends Item> T registerItem(String path, T item) {
        ITEMS.put(new CandlelightIdentifier(path), item);
        return item;
    }
    ...
    private static FoodComponent BottleFoodComponent(StatusEffect effect) {
    ...
    private static AbstractBlock.Settings getBottleSettings() {
