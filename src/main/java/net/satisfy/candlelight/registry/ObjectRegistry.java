...
public class ObjectRegistry {
    ...
    public static final Item TOMATO_SOUP = register("tomato_soup", new EffectFoodItem(getSettings().food(CandlelightFoods.TOMATO_SOUP), 1));
    public static final Item MUSHROOM_SOUP = register("mushroom_soup", new EffectFoodItem(getSettings().food(CandlelightFoods.MUSHROOM_SOUP), 1));
    public static final Item BEETROOT_SALAD = register("beetroot_salad", new EffectFoodItem(getSettings().food(FoodComponents.BEETROOT_SOUP), 1));
    public static final Item PASTA = register("pasta", new EffectFoodItem(getSettings().food(CandlelightFoods.PASTA), 2));
    public static final Item BOLOGNESE = register("bolognese", new EffectFoodItem(getSettings().food(CandlelightFoods.COOKED_BEEF), 1));
    public static final Item BEEF_TARTARE = register("beef_tartare", new Item(getSettings().food(FoodComponents.COOKED_BEEF)));
    public static final Item COOKED_BEEF = register("cooked_beef", new EffectFoodItem(getSettings().food(CandlelightFoods.COOKED_BEEF), 2));
    public static final Item BROCCOLI_BEEF = register("broccoli_beef", new EffectFoodItem(getSettings().food(CandlelightFoods.BROCCOLI_BEEF), 2));
    public static final Block BROCCOLI_TOMATO_BLOCK = registerBlockWithoutItem("broccoli_tomato_block", new EffectFoodTrayBlock(FabricBlockSettings.copyOf(Blocks.CAKE), 2,CandlelightFoods.BROCCOLI_TOMATO));
    public static final Item BROCCOLI_TOMATO = register("broccoli_tomato", new EffectFoodBlockItem(BROCCOLI_TOMATO_BLOCK, getSettings().food(CandlelightFoods.BROCCOLI_TOMATO), 2));
    public static final Item SALMON_WINE = register("salmon_wine", new EffectFoodItem(getSettings().food(CandlelightFoods.SALMON_ON_WHITE_WINE), 2));
    public static final Item VEGGIE_PLATE = register("veggie_plate", new EffectFoodItem(getSettings().food(FoodComponents.COOKED_BEEF), 2));
    public static final Block PORK_RIBS_BLOCK = registerBlockWithoutItem("pork_ribs_block", new EffectFoodBlock(FabricBlockSettings.copyOf(Blocks.CAKE), 2, CandlelightFoods.PORK_RIBS));
    public static final Item PORK_RIBS = register("pork_ribs", new EffectFoodBlockItem(PORK_RIBS_BLOCK, getSettings().food(CandlelightFoods.PORK_RIBS), 2));
    public static final Item MASHED_POTATOES = register("mashed_potatoes", new EffectFoodItem(getSettings().food(FoodComponents.GOLDEN_CARROT), 2));
    public static final Item FRICASSE = register("fricasse", new EffectFoodItem(getSettings().food(CandlelightFoods.FRICASSE), 2));
    public static final Item CHICKEN = register("chicken", new EffectFoodItem(getSettings().food(FoodComponents.GOLDEN_CARROT), 2));
    public static final Block TOMATO_MOZZARELLA_BLOCK = registerBlockWithoutItem("tomato_mozzarella_block", new EffectFoodTrayBlock(FabricBlockSettings.copyOf(Blocks.CAKE), 2,CandlelightFoods.TOMATO_MOZZARELLA_SALAD));
    public static final Item TOMATO_MOZZARELLA_SALAD = register("tomato_mozzarella_salad", new EffectFoodBlockItem(TOMATO_MOZZARELLA_BLOCK, getSettings().food(CandlelightFoods.TOMATO_MOZZARELLA_SALAD), 2));
    ...
    public static final Item LASAGNA = register("lasagne", new EffectFoodBlockItem(LASAGNA_BLOCK, getSettings().food(CandlelightFoods.LASAGNE), 3));
    public static final Item ROASTBEEF_CARROTS = register("roastbeef_carrots", new EffectFoodItem(getSettings().food(CandlelightFoods.ROASTBEEF_CARROTS), 2));
    public static final Block BEEF_WELLINGTON_BLOCK = registerBlockWithoutItem("beef_wellington_block", new EffectFoodBlock(FabricBlockSettings.copyOf(Blocks.CAKE), 2,CandlelightFoods.BEEF_WELLINGTON));
    public static final Item BEEF_WELLINGTON = register("beef_wellington", new EffectFoodBlockItem(BEEF_WELLINGTON_BLOCK, getSettings().food(CandlelightFoods.BEEF_WELLINGTON), 2));
