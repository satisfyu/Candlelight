...
/*
	public static final ItemGroup ITEM_GROUP_TABBED_ICON_TEXTURES =
			TabbedItemGroup.builder()
					.defaultPredicate(Tab.Predicate.CONTAINS)
					.tab(Tab.builder().predicate(Tab.Predicate.items(
 ...
 */
	...
	public void onInitialize() {
		...
		Tab tab = Tab.builder().predicate(
				...
				ObjectRegistry.WOOD_FIRED_OVEN.asItem(),
				ObjectRegistry.STOVE.asItem(),
				ObjectRegistry.SIDEBOARD.asItem(),
				ObjectRegistry.DRAWER.asItem(),
				ObjectRegistry.KITCHEN_SINK.asItem(),
