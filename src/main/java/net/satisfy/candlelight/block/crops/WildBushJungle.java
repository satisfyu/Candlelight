...
public class WildBushJungle extends PlantBlock implements Fertilizable {
    ...
    public WildBushJungle(Settings settings) {
        this(settings, 5);
    }

    public WildBushJungle(Settings settings, int chance) {
        super(settings);
        this.chance = chance;
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (!bl && player.getStackInHand(hand).isOf(Items.BONE_MEAL)) {
            ...
            dropStack(world, pos, new ItemStack(ObjectRegistry.STRAWBERRY, x + (bl ? 1 : 0)));
