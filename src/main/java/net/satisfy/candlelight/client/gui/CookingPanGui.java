...
public class CookingPanGui extends HandledScreen<CookingPanGuiHandler> {

    private static final Identifier BG = new CandlelightIdentifier("textures/gui/pan_gui.png");
