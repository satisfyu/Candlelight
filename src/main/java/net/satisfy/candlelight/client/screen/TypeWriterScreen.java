...
public class TypeWriterScreen extends Screen {
    ...
    public TypeWriterScreen(PlayerEntity player, ItemStack itemStack, Hand hand) {
        super(NarratorManager.EMPTY);
        this.pageContent = TypeWriterScreen.PageContent.EMPTY;
        this.player = player;
    ...
    public TypeWriterScreen(PlayerEntity player, ItemStack itemStack, Hand hand, BlockPos pos)
    {
    ...
    private void finalizeBook(boolean signBook) {
        if (this.dirty) {
            ...
            ClientPlayNetworking.send(CandlelightMessages.TYPEWRITER_SYNC, buf);
    ...
    private PageContent createPageContent() {
        String string = this.getCurrentPageContent();
        if (string.isEmpty()) {
            return TypeWriterScreen.PageContent.EMPTY;
        } else {
            int i = this.currentPageSelectionManager.getSelectionStart();
